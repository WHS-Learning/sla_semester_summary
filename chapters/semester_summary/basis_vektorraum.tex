...
Weil es sich um drei linear unabhängige Vektoren im dreidimensionalen Raum $\mathbb{R}^3$ handelt (Anzahl der Vektoren = Dimension des Raumes), bilden sie eine Basis des $\mathbb{R}^3$.